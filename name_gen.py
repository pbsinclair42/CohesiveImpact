...
def startup_words():
	buzzadj = ['Grass-roots', 'Synergistic' , 'Proactive','Adhesive','Cohesive','Practical','Robust','Sustainabale','Functional','Transformative','Dynamic','Worldwide']
	buzznouns = ['Synergy', 'Adhesion','Cohesion','Impact','Globalization']
	computer = ['Cache','API','Mainframe','Firewall','Server','Cloud','RAM','Online','Doge','Memes','Networking','Social Media']
	company = ['.com','Enterprises','Ltd.','International','Incorporated','Consolidated', 'Global', 'Security','Technologies']
